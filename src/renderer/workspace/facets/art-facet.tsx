...
// local state lives in the launcher (Canvas slot).
//
// THE DOC-HEADER SAVE BUTTON no longer owns the save. `handleSave` moved to
// state/art-composer-save.ts as `saveComposerDocument` so the SaveCoordinator
// can reach it too: this document is on the unsaved-work perimeter, and while
// one React button was its only writer, the open/close guards' "Save & …"
