...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: T.tLg, fontWeight: T.wSemibold, color: T.textHi },
  infoCard: {
  ...
  issueTitle: { fontSize: T.tXs, fontWeight: T.wSemibold, color: T.warning },
  ...
  key: { fontFamily: T.fontMono, fontSize: T.tXs, color: T.textBase, width: 220, flexShrink: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const },
  pathInput: {
    flex: 1, minWidth: 0, padding: '2px 8px', background: T.surface,
    border: `1px solid ${T.border}`, borderRadius: T.rSm,
    color: T.textHi, fontSize: T.tXs, fontFamily: T.fontMono,
  },
  footer: {
    display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 12,
    padding: '8px 16px', borderTop: `1px solid ${T.border}`, background: T.void, flexShrink: 0,
  },
  footerHint: { fontSize: T.tXs, color: T.textLo },
  applyButton: {
    padding: '5px 16px', background: T.accent, color: T.onAccent, fontWeight: T.wSemibold,
