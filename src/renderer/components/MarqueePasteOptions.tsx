...
const styles: Record<string, React.CSSProperties> = {
  ...
  nameInput: { flex: 1, minWidth: 0, padding: `2px ${T.s2}`, background: T.overlay, color: T.textBase, border: `1px solid ${T.border}`, borderRadius: T.rSm, fontSize: 11 },
  saveBtn: { padding: `2px ${T.s2}`, background: T.accent, color: T.onAccent, border: `1px solid ${T.accent}`, borderRadius: T.rSm, cursor: 'pointer', fontSize: 11, flexShrink: 0, whiteSpace: 'nowrap' },
};
