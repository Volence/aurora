...
const styles: Record<string, React.CSSProperties> = {
  ...
  sizeBtn: { padding: '3px 7px', background: T.raised, color: T.textHi, border: `1px solid ${T.borderStrong}`, borderRadius: 4, cursor: 'pointer', fontSize: T.tXs },
  ...
  nameInput: { background: T.raised, color: T.textHi, border: `1px solid ${T.borderStrong}`, borderRadius: 4, fontSize: T.tSm, padding: '4px 6px' },
  btnRow: { display: 'flex', gap: 6 },
  check: { fontSize: T.tXs, color: T.textBase, display: 'flex', alignItems: 'center', gap: 4, cursor: 'pointer' },
  hint: { fontSize: T.t2xs, color: T.textFaint, lineHeight: 1.3 },
  notice: { fontSize: T.t2xs, color: T.textLo, lineHeight: 1.35, padding: '5px 7px', background: T.void, border: `1px solid ${T.borderStrong}`, borderRadius: 4 },
  ...
  fmtSelect: { flex: 1, background: T.raised, color: T.textHi, border: `1px solid ${T.borderStrong}`, borderRadius: 4, fontSize: T.tSm, padding: '4px 6px' },
  ...
  scanRow: { display: 'flex', alignItems: 'center', gap: 6, padding: '2px 4px', borderRadius: T.rMd, background: T.raised },
  scanName: { flex: 1, fontSize: T.tXs, color: T.textHi, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  scanBadges: { display: 'flex', alignItems: 'center', gap: 3 },
  scanGame: { fontSize: T.t2xs, color: T.textLo, fontWeight: T.wSemibold },
  scanTag: { fontSize: T.t2xs, color: T.onAccent, background: T.success, borderRadius: 2, padding: '0 3px', fontWeight: T.wSemibold },
  scanOpen: { padding: '2px 8px', background: T.raised, color: T.textHi, border: `1px solid ${T.borderStrong}`, borderRadius: T.rMd, cursor: 'pointer', fontSize: T.tXs },
  primary: { flex: 1, padding: '5px 8px', background: T.success, color: T.onAccent, border: 'none', borderRadius: 4, cursor: 'pointer', fontSize: T.tSm, fontWeight: T.wSemibold },
  secondary: { flex: 1, padding: '5px 8px', background: T.raised, color: T.textHi, border: `1px solid ${T.borderStrong}`, borderRadius: 4, cursor: 'pointer', fontSize: T.tSm },
