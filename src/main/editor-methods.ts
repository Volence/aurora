...
export const EDITOR_METHODS: EditorMethod[] = [
  ...
  { name: 'get_palette', kind: 'get-palette', result: 'json', params: {},
    description: 'The active 4x16 palette as RGB per line plus Genesis CRAM words (0000BBB0GGG0RRR0, ready to pass back to set_palette). Line 0 is the Sonic and Tails palette, one file shared by every zone: set_palette refuses it, and a person can change it in the palette editor behind a warning. Index 0 of each line is transparent.' },
  ...
  { name: 'set_palette', kind: 'set-palette', result: 'json',
    ...
    description: 'Write one palette line (1-3) as 16 Genesis CRAM words (0000BBB0GGG0RRR0, even channel values only). One undo step. Line 0 is refused: it is the Sonic and Tails palette, one file shared by every zone, which a person can change in the palette editor behind a warning.' },
