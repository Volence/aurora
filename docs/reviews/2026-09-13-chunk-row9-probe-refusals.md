...
`VITEST_MAX_WORKERS=4 npm test`, foreground, over this packet's commit: see the section
"Node-suite totals" appended below. The worktree had **no** `node_modules` at all (not the symlink
