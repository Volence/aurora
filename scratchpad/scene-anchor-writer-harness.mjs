...
async function main() {
  ...
  try {
    ...
    // the project opens anyway. Uncaught, it killed this rig before its first
    // row. Why the promise is collected is a different defect and is NOT
    // measured here; [1a] below is what says whether the project really opened.
